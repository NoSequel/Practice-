...
public class JsonAppender {
    ...
    /**
     * Constructor for creating a new JsonAppender instance with a new {@link JsonObject}
     */
    public JsonAppender() {
        this(null);
    }
     ...
     *
     * @param object the preexisting {@link JsonObject}, if null it creates a new {@link JsonObject}
     */
    ...
    /**
     * Get the {@link JsonObject} from the JsonAppender instance
     *
     * @return the object
     */
