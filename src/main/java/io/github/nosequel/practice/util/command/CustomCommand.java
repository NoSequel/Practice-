package io.github.nosequel.practice.util.command;

import io.github.nosequel.practice.util.command.adapter.TypeAdapter;
import io.github.nosequel.practice.util.command.data.CommandData;
import io.github.nosequel.practice.util.command.data.SubcommandData;
    ...
    public boolean execute(CommandSender sender, String label, String[] passedParameters) {
        ...
        if (parameters.length > 0 && !parameters[0].getType().isArray()) {
            ...
            for (int i = 0; i < parameters.length; i++) {
                ...
                final io.github.nosequel.practice.util.command.annotation.Parameter param = parameter.getAnnotation(io.github.nosequel.practice.util.command.annotation.Parameter.class);
                String value;
